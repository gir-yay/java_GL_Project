...
public class Historique extends javax.swing.JFrame {
    ...
    public void fill() {
        try {
            ...
            while (rs.next()) {
                System.out.println("Row from database: " + rs.getInt("id") + ", " + rs.getString("Nom_complet") + ", "
                        + rs.getString("email") + ", Attestation de réussite"); // Debug print
                model.addRow(new Object[] { rs.getString("Nom_complet"), rs.getInt("student.CNE"),
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (viewRow < 0) {
                    ...
                    // Do something with the data from the selected row
                    System.out.println("Row from database: " + jTable2.getValueAt(viewRow, 0) + ", "
                            + jTable2.getValueAt(viewRow, 1) + ", " + jTable2.getValueAt(viewRow, 2) + ", "
                            + jTable2.getValueAt(viewRow, 3) + ", " + jTable2.getValueAt(viewRow, 4));
                }
            }
        });
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                                layout.createSequentialGroup()
                                                                        ...
                                                                        .addGap(217, 217, 217))))
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 676,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
