 ...
 * @author pc
 */
public class ResumeResclamation extends javax.swing.JFrame {

    /**
     * Creates new form ResumeResclamation
     */
    public ResumeResclamation() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResumeResclamation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResumeResclamation().setVisible(true);
            }
        });
    }
